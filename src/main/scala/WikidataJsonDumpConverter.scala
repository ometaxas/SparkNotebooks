...
object WikidataJsonDumpConverter {
    ...
    def main(args: Array[String]): Unit = {
                ...
                val df = spark.sparkContext.
                    textFile("/home/ometaxas/Datasets/Wikidata/latest-all.json.gz").
                ...
                df.repartition(256).write.mode(SaveMode.Overwrite).format("parquet").save("/media/datadisk/Datasets/WikiData")
